...
await page.screenshot({ path: 'C:/Users/Zonlic/Desktop/ZonKey/temp_ui_test/shots_mnav/05_fav_with_item.png' });
// 点击收藏项应跳到对应工具
...
if (await item.count()) {
  ...
  await page.screenshot({ path: 'C:/Users/Zonlic/Desktop/ZonKey/temp_ui_test/shots_mnav/06_jump_merge.png' });
}
