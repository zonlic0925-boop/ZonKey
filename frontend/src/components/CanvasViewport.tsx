  ...
  return (
    <div className="flex-1 relative flex flex-col h-full overflow-hidden select-none bg-mem-cream/50 min-h-0">
      <div className="flex-1 min-h-0 flex flex-row overflow-hidden">
        {/* 左侧工具轨：不覆盖图纸像素区域 */}
        <aside className="shrink-0 w-11 sm:w-12 flex flex-col items-center gap-1 py-2 px-1 border-r-[3px] border-mem-ink bg-white/95 z-20">
          <div className="flex flex-col p-0.5 rounded-lg bg-mem-cream border-2 border-mem-ink/20">
            <button
              ...
              className={`p-1.5 rounded-md transition-all disabled:opacity-30 ${
                mode === 'select'
                  ? 'bg-mem-yellow border-2 border-mem-ink shadow-memphis-sm'
            ...
            <button
              ...
              className={`p-1.5 rounded-md transition-all disabled:opacity-30 ${
                mode === 'rect'
                  ? 'bg-mem-teal border-2 border-mem-ink shadow-memphis-sm'
                  : 'text-mem-ink/50 hover:text-mem-ink'
              }`}
            >
          ...
          <button
            ...
            className="memphis-btn-ghost p-1.5 disabled:opacity-30"
          >
        ...
        {displayPage ? (
          ...
          >
            <img
              ...
              className="max-h-[calc(100vh-120px)] sm:max-h-[calc(100vh-108px)] max-w-full object-contain pointer-events-none select-none"
              draggable={false}
              onLoad={() => {
                setImageReady(true)
                syncImageMetrics()
      ...
      <div className="shrink-0 min-h-12 px-2 sm:px-3 py-1.5 bg-white border-t-[3px] border-mem-ink flex flex-wrap items-center justify-between z-20 gap-x-2 gap-y-1">
        ...
        <div className="flex items-center gap-1 flex-wrap justify-center">
          <button
            ...
            className="memphis-btn-ghost flex items-center gap-1 disabled:opacity-30 px-2 py-1"
          >
        ...
        <div className="flex items-center gap-1 shrink-0">
          <button
            ...
            className="memphis-btn-ghost p-1.5"
            title={t('canvas.zoomOut')}
          >
            <ZoomOut className="w-4 h-4" />
          </button>
          <span className="text-xs font-mono text-mem-ink/60 w-10 text-center">
            {Math.round(zoom * 100)}%
          </span>
          <button
