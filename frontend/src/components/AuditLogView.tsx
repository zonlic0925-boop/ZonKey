        ...
        <div className="flex-1 overflow-y-auto py-3 space-y-2.5 pr-1">
          ...
          {!loading &&
            logs.map((log) => (
              <div
                key={log.id}
                className="p-4 rounded-xl bg-white border-2 border-mem-ink/15 hover:border-mem-ink/40 hover:shadow-memphis-sm transition-all flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3"
              >
