...
import { X, Coffee, Mail } from 'lucide-react';
import { APP_NAME, AUTHOR_EMAIL, SUPPORT_ALIPAY_QR, SUPPORT_WECHAT_QR } from '../lib/brand';
...
export const SupportAuthorModal: React.FC<SupportAuthorModalProps> = ({ open, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="memphis-card max-w-lg w-full p-6 relative animate-in fade-in zoom-in-95 duration-200"
