...
export default function App() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden flex flex-col bg-mem-cream font-body text-mem-ink select-none">
      <MemphisDecor />
      ...
      {notification && (
        <div className="fixed bottom-6 right-6 z-50 memphis-toast animate-in fade-in slide-in-from-bottom-5">
