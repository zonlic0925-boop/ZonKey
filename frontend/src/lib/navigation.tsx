...
export const CENTER_TOOLS: Record<CenterId, ToolMeta[]> = {
  ...
  pdf_center: [
    ...
    { id: 'pdf-bookmarks', labelKey: 'tools.pdfBookmarks', availability: 'ready', group: 'edit' },
    // 转换
    ...
    { id: 'word-to-pdf', labelKey: 'tools.wordToPdf', availability: 'ready', group: 'convert' },
    { id: 'excel-to-pdf', labelKey: 'tools.excelToPdf', availability: 'ready', group: 'convert' },
  ...
  image_center: [
    ...
    { id: 'image-mask', labelKey: 'tools.imageMask', availability: 'ready' },
    { id: 'id-photo', labelKey: 'tools.idPhoto', availability: 'ready' },
  ...
  text_center: [
    ...
    { id: 'text-diff', labelKey: 'tools.textDiff', availability: 'ready' },
    { id: 'regex-tester', labelKey: 'tools.regexTester', availability: 'ready' },
    { id: 'batch-rename', labelKey: 'tools.batchRename', availability: 'ready' },
    { id: 'tts', labelKey: 'tools.tts', availability: 'ready' },
  ...
  system_tools: [
    ...
    { id: 'duplicate-finder', labelKey: 'tools.dupFinder', availability: 'ready' },
