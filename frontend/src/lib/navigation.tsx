...
export const CENTER_TOOLS: Record<CenterId, ToolMeta[]> = {
  ...
  calc_dev: [
    { id: 'bmi-calc', labelKey: 'tools.bmiCalc', availability: 'planned' },
    { id: 'timestamp-calc', labelKey: 'tools.timestampCalc', availability: 'planned' },
    { id: 'mortgage-calc', labelKey: 'tools.mortgageCalc', availability: 'planned' },
    { id: 'interest-calc', labelKey: 'tools.interestCalc', availability: 'planned' },
    { id: 'password-gen', labelKey: 'tools.passwordGen', availability: 'planned' },
    { id: 'json-tools', labelKey: 'tools.jsonTools', availability: 'planned' },
    { id: 'base64', labelKey: 'tools.base64', availability: 'planned' },
    { id: 'url-codec', labelKey: 'tools.urlCodec', availability: 'planned' },
    { id: 'uuid', labelKey: 'tools.uuid', availability: 'planned' },
    { id: 'jwt', labelKey: 'tools.jwt', availability: 'planned' },
    { id: 'hash-crypto', labelKey: 'tools.hashCrypto', availability: 'planned' },
  ],
  system_tools: [
